...
**v0.1.0** ships the **Linux** app. **RetroDECK** is the supported platform (auto-detect). Other library trees (EmuDeck, plain ES-DE, custom) use manual Target paths. **Android is out of scope** — use [Argosy](https://github.com/rommapp/argosy-launcher).
